...
Runnable minimal examples are available under `sqlrec-demo/src/main/java/com/sqlrec/demo/udf/`. See the [Programming Model](../program_model.md#udf) for detailed overload, context-injection, and compilation behavior.
