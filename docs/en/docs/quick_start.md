...
Then call the `demo_rec` recommendation API:
...
The endpoint returns the result of `demo_rec`. Test data inserted through the SQL API and exposure data generated by recommendations remain in the HTTP service process until the container stops.
