...
HTTP connect/read/write timeouts default to 30 seconds. See [Model Training and Online Inference](../../guides/model-lifecycle.md#call-a-model-service) for the protocol and examples.
