...
export HDFS_NAMENODE_PORT="${HDFS_NAMENODE_PORT:-32400}"
export HDFS_DATANODE_PORT="${HDFS_DATANODE_PORT:-32401}"
export HDFS_NAMENODE_HTTP_PORT="${HDFS_NAMENODE_HTTP_PORT:-32402}"
export HDFS_DATANODE_HTTP_PORT="${HDFS_DATANODE_HTTP_PORT:-32403}"
...
export HMS_POSTGRESQL_PORT="${HMS_POSTGRESQL_PORT:-30307}"
...
export SQL_GATEWAY_PORT="${SQL_GATEWAY_PORT:-30000}"
export FLINK_JOBMANAGER_PORT="${FLINK_JOBMANAGER_PORT:-30001}"

export JUICEFS_REDIS_PORT="${JUICEFS_REDIS_PORT:-30306}"
export MINIO_PORT="${MINIO_PORT:-32000}"
export MINIO_CONSOLE_PORT="${MINIO_CONSOLE_PORT:-32001}"
...
export KAFKA_PORT="${KAFKA_PORT:-32092}"

export VALKEY_VERSION="${VALKEY_VERSION:-9.0.2}"
export REDIS_PORT="${REDIS_PORT:-32379}"

export MILVUS_VERSION="${MILVUS_VERSION:-v2.6.2}"
export MILVUS_PORT="${MILVUS_PORT:-31530}"

export TEST_POSTGRESQL_PORT="${TEST_POSTGRESQL_PORT:-30309}"
export TEST_POSTGRESQL_USER="${TEST_POSTGRESQL_USER:-test}"
export TEST_POSTGRESQL_PASSWORD="${TEST_POSTGRESQL_PASSWORD:-abc123456}"

export SQLREC_POSTGRESQL_PORT="${SQLREC_POSTGRESQL_PORT:-30308}"
...
export SQLREC_THRIFT_PORT="${SQLREC_THRIFT_PORT:-30300}"
export SQLREC_REST_PORT="${SQLREC_REST_PORT:-30301}"
export SQLREC_DEBUG_PORT="${SQLREC_DEBUG_PORT:-30302}"

export JUPYTERHUB_VERSION="${JUPYTERHUB_VERSION:-4.3.1}"
export JUPYTERHUB_PORT="${JUPYTERHUB_PORT:-30280}"
...
export MONGODB_PORT="${MONGODB_PORT:-30281}"
...
export GROWTHBOOK_MONGODB_PORT="${GROWTHBOOK_MONGODB_PORT:-30282}"
...
export GROWTHBOOK_WEB_PORT="${GROWTHBOOK_WEB_PORT:-30283}"
export GROWTHBOOK_API_PORT="${GROWTHBOOK_API_PORT:-30284}"

export DOLPHINSCHEDULER_VERSION="${DOLPHINSCHEDULER_VERSION:-3.4.1}"
export DOLPHINSCHEDULER_POSTGRESQL_PORT="${DOLPHINSCHEDULER_POSTGRESQL_PORT:-30305}"
...
export DOLPHINSCHEDULER_PORT="${DOLPHINSCHEDULER_PORT:-30287}"

export CLICKHOUSE_VERSION="${CLICKHOUSE_VERSION:-25.3}"
export CLICKHOUSE_HTTP_PORT="${CLICKHOUSE_HTTP_PORT:-32412}"
export CLICKHOUSE_TCP_PORT="${CLICKHOUSE_TCP_PORT:-32410}"
export CLICKHOUSE_USER="${CLICKHOUSE_USER:-default}"
export CLICKHOUSE_PASSWORD="${CLICKHOUSE_PASSWORD:-abc123456}"

export MYSQL_VERSION="${MYSQL_VERSION:-8.4}"
export MYSQL_NAME=mysql
export MYSQL_PORT="${MYSQL_PORT:-30336}"
...
export GRAFANA_PORT="${GRAFANA_PORT:-30285}"
export PROMETHEUS_PORT="${PROMETHEUS_PORT:-30286}"

export JAEGER_VERSION="${JAEGER_VERSION:-2.19.0}"
export JAEGER_UI_PORT="${JAEGER_UI_PORT:-30288}"
export JAEGER_OTLP_GRPC_PORT="${JAEGER_OTLP_GRPC_PORT:-30289}"
export JAEGER_OTLP_HTTP_PORT="${JAEGER_OTLP_HTTP_PORT:-30290}"

export OPENSEARCH_VERSION="${OPENSEARCH_VERSION:-2.19.1}"
export OPENSEARCH_HTTP_PORT="${OPENSEARCH_HTTP_PORT:-30920}"
export OPENSEARCH_PASSWORD="${OPENSEARCH_PASSWORD:-Sqlrec_123456}"
export OPENSEARCH_DASHBOARDS_PORT="${OPENSEARCH_DASHBOARDS_PORT:-30561}"
