...
public class MilvusFilterCompatibilityTest {
    ...
    public void testBuildMilvusFilterExpression_NullCondition() {
        ...
        String result = MilvusFilterBuilder.buildJoinFilter(null, leftValue, rightFieldNames);
        assertNull(result);
    }
    ...
    public void testBuildMilvusFilterExpression_NullLeftValue() {
        ...
        String result = MilvusFilterBuilder.buildJoinFilter(filterCondition, null, rightFieldNames);
    ...
    public void testBuildMilvusFilterExpression_AndCondition() {
        ...
        String result = MilvusFilterBuilder.buildJoinFilter(andCondition, leftValue, rightFieldNames);
    ...
    public void testBuildMilvusFilterExpression_OrCondition() {
        ...
        String result = MilvusFilterBuilder.buildJoinFilter(orCondition, leftValue, rightFieldNames);
    ...
    public void testBuildMilvusFilterExpression_ComplexAndOrCondition() {
        ...
        String result = MilvusFilterBuilder.buildJoinFilter(orCond, leftValue, rightFieldNames);
    ...
    public void testGetMilvusFilterSqlString_Empty() {
        assertEquals("", MilvusFilterBuilder.buildScanFilter(Collections.emptyList(), milvusFieldSchemas));
    }

    @Test
    public void testGetMilvusFilterSqlString_Null() {
        assertEquals("", MilvusFilterBuilder.buildScanFilter((List<RexNode>) null, milvusFieldSchemas));
    }
    ...
    public void testGetMilvusFilterSqlString_AndCondition() {
        ...
        String result = MilvusFilterBuilder.buildScanFilter(Collections.singletonList(andFilter), milvusFieldSchemas);
    ...
    public void testGetMilvusFilterSqlString_OrCondition() {
        ...
        String result = MilvusFilterBuilder.buildScanFilter(Collections.singletonList(orFilter), milvusFieldSchemas);
        assertEquals("(id == 1) OR (name == \"Alice\")", result);
    }

    @Test
    public void testGetMilvusFilterSqlString_UnsupportedCompoundChildReturnsNull() {
        ...
        assertNull(MilvusFilterBuilder.buildScanFilter(
                Collections.singletonList(andFilter), milvusFieldSchemas));
        assertNull(MilvusFilterBuilder.buildScanFilter(
                Collections.singletonList(orFilter), milvusFieldSchemas));
    }
    ...
    public void testGetMilvusFilterSqlString_MultipleFilters() {
        ...
        String result = MilvusFilterBuilder.buildScanFilter(Arrays.asList(filter), milvusFieldSchemas);
        assertEquals("id == 1", result);
    }
    ...
    public void testGetMilvusFilterSqlString_RejectsUnsafeFieldName() {
        ...
        assertThrows(IllegalArgumentException.class,
                () -> MilvusFilterBuilder.buildScanFilter(Collections.singletonList(filter), evilSchemas));
    }
    ...
    public void testBuildMilvusFilterExpression_RejectsUnsafeFieldName() {
        ...
        assertThrows(IllegalArgumentException.class,
                () -> MilvusFilterBuilder.buildJoinFilter(filterCondition, leftValue, evilFieldNames));
    }
    ...
    public void testGetMilvusFilterSqlString_ArrayContains() {
        ...
        assertEquals("array_contains(tags, \"a\")",
                MilvusFilterBuilder.buildScanFilter(Collections.singletonList(filter), arrayFieldSchemas));
    }
    ...
    public void testGetMilvusFilterSqlString_NullLiteral() {
        ...
        assertEquals("name == null",
                MilvusFilterBuilder.buildScanFilter(Collections.singletonList(filter), milvusFieldSchemas));
    }
    ...
    public void testBuildMilvusFilterExpression_MixedJoinConjunction() {
        ...
        assertTrue(MilvusFilterBuilder.supportsJoinFilter(condition, 1, 2));
        assertEquals(
                "(category == \"book\" and id > 10)",
                MilvusFilterBuilder.buildJoinFilter(
                        condition,
                        new Object[]{"book"},
    ...
    public void testCanBuildMilvusJoinFilter_RejectsMixedOr() {
        ...
        assertFalse(MilvusFilterBuilder.supportsJoinFilter(
