...
public class MilvusEnumerableTableModifyRule extends ConverterRule {
    public static final Config DEFAULT_CONFIG = Config.INSTANCE
            .withConversion(LogicalTableModify.class, Convention.NONE,
                    EnumerableConvention.INSTANCE, "MilvusEnumerableTableModifyRule")
            .withRuleFactory(MilvusEnumerableTableModifyRule::new);

    protected MilvusEnumerableTableModifyRule(Config config) {
        super(config);
    }
    ...
    public boolean matches(RelOptRuleCall call) {
        ...
        if (table != null && table.unwrap(MilvusCalciteTable.class) != null) {
            return true;
        }
        return false;
    }
