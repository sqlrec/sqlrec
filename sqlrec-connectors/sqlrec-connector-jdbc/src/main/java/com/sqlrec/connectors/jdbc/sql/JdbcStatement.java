 ...
 *
 * <p>Instances can only be created inside this package through
 * {@link JdbcSqlBuilder} and {@link JdbcFilterBuilder}. Callers outside the package
 * cannot construct a statement
...
public final class JdbcStatement {
    ...
    JdbcStatement(String sql, List<?> parameters) {
     ...
     */
    public JdbcStatement withParameters(List<?> parameters) {
        return new JdbcStatement(sql, parameters);
    }
    ...
    public String toString() {
        return "JdbcStatement{sql='" + sql + "', parameterCount=" + parameters.size() + "}";
    }
}
