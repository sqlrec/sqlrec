...
-- Generate a mock query vector so the benchmark still covers Milvus search
-- without calling a model service.
...
cache table rec_item as
call rank_fun_simple(full_user_info, recall_item)
like function 'rank_fun_simple';
